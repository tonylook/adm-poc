  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="admpocApp.vesselTimeContract.home.createOrEditLabel" data-cy="VesselTimeContractCreateUpdateHeading">
            <Translate contentKey="admpocApp.vesselTimeContract.home.createOrEditLabel">Create or edit a VesselTimeContract</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('admpocApp.vesselTimeContract.holds')}
              ...
              />
              <ValidatedField
                label={translate('admpocApp.vesselTimeContract.holdCapacity')}
              ...
              />
              <ValidatedField
                label={translate('admpocApp.vesselTimeContract.period')}
              ...
              />
              <ValidatedField
                label={translate('admpocApp.vesselTimeContract.costPerDay')}

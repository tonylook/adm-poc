...
export const VesselTimeContractDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="admpocApp.vesselTimeContract.delete.question">
        <Translate contentKey="admpocApp.vesselTimeContract.delete.question" interpolate={{ id: vesselTimeContractEntity.id }}>

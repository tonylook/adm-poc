...
export const PurchaseContractDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="admpocApp.purchaseContract.delete.question">
        <Translate contentKey="admpocApp.purchaseContract.delete.question" interpolate={{ id: purchaseContractEntity.id }}>

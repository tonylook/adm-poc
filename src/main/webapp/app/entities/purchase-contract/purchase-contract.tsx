  ...
  return (
    <div>
      <h2 id="purchase-contract-heading" data-cy="PurchaseContractHeading">
        <Translate contentKey="admpocApp.purchaseContract.home.title">Purchase Contracts</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="admpocApp.purchaseContract.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="admpocApp.purchaseContract.home.createLabel">Create new Purchase Contract</Translate>
          </Link>
        </div>
      </h2>
        ...
        {purchaseContractList && purchaseContractList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="admpocApp.purchaseContract.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="admpocApp.purchaseContract.purchasingWindow">Purchasing Window</Translate>
                </th>
                <th>
                  <Translate contentKey="admpocApp.purchaseContract.soymealQuality">Soymeal Quality</Translate>
                </th>
                <th>
                  <Translate contentKey="admpocApp.purchaseContract.price">Price</Translate>
                </th>
                <th>
                  <Translate contentKey="admpocApp.purchaseContract.volume">Volume</Translate>
                </th>
                <th>
                  <Translate contentKey="admpocApp.purchaseContract.status">Status</Translate>
                </th>
                <th>
                  <Translate contentKey="admpocApp.purchaseContract.port">Port</Translate>
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {purchaseContractList.map((purchaseContract, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`admpocApp.Quality.${purchaseContract.soymealQuality}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="admpocApp.purchaseContract.home.notFound">No Purchase Contracts found</Translate>
            </div>
          )
        )}
      </div>

  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="admpocApp.purchaseContract.home.createOrEditLabel" data-cy="PurchaseContractCreateUpdateHeading">
            <Translate contentKey="admpocApp.purchaseContract.home.createOrEditLabel">Create or edit a PurchaseContract</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('admpocApp.purchaseContract.purchasingWindow')}
              ...
              />
              <ValidatedField
                label={translate('admpocApp.purchaseContract.soymealQuality')}
              ...
              >
                {qualityValues.map(quality => (
                  <option value={quality} key={quality}>
                    {translate('admpocApp.Quality.' + quality)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('admpocApp.purchaseContract.price')}
              ...
              />
              <ValidatedField
                label={translate('admpocApp.purchaseContract.volume')}
              ...
              />
              <ValidatedField
                label={translate('admpocApp.purchaseContract.status')}
              ...
              <ValidatedField
                ...
                name="port"
                data-cy="port"
                label={translate('admpocApp.purchaseContract.port')}
                type="select"
              >
                <option value="" key="0" />
                {ports

  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="admpocApp.port.home.createOrEditLabel" data-cy="PortCreateUpdateHeading">
            <Translate contentKey="admpocApp.port.home.createOrEditLabel">Create or edit a Port</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('admpocApp.port.lodingTime')}
                id="port-lodingTime"
                name="lodingTime"
                data-cy="lodingTime"
                type="text"
              />
              <ValidatedField
                label={translate('admpocApp.port.unloadingTime')}
              ...
              />
              <ValidatedField
                label={translate('admpocApp.port.waitingTime')}
                id="port-waitingTime"
                name="waitingTime"
                data-cy="waitingTime"
                type="text"

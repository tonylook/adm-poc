  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="admpocApp.saleContract.home.createOrEditLabel" data-cy="SaleContractCreateUpdateHeading">
            <Translate contentKey="admpocApp.saleContract.home.createOrEditLabel">Create or edit a SaleContract</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('admpocApp.saleContract.deliveryWindow')}
              ...
              />
              <ValidatedField
                label={translate('admpocApp.saleContract.soymealQuality')}
              ...
              <ValidatedField
                label={translate('admpocApp.saleContract.price')}
              ...
              />
              <ValidatedField
                label={translate('admpocApp.saleContract.volume')}
              ...
              />
              <ValidatedField
                label={translate('admpocApp.saleContract.allowances')}
              ...
              />
              <ValidatedField
                label={translate('admpocApp.saleContract.status')}

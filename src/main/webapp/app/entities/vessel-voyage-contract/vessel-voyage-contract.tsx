  ...
  return (
    <div>
      <h2 id="vessel-voyage-contract-heading" data-cy="VesselVoyageContractHeading">
        <Translate contentKey="admpocApp.vesselVoyageContract.home.title">Vessel Voyage Contracts</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="admpocApp.vesselVoyageContract.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="admpocApp.vesselVoyageContract.home.createLabel">Create new Vessel Voyage Contract</Translate>
          </Link>
        </div>
      </h2>
        ...
        {vesselVoyageContractList && vesselVoyageContractList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="admpocApp.vesselVoyageContract.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="admpocApp.vesselVoyageContract.holds">Holds</Translate>
                </th>
                <th>
                  <Translate contentKey="admpocApp.vesselVoyageContract.holdCapacity">Hold Capacity</Translate>
                </th>
                <th>
                  <Translate contentKey="admpocApp.vesselVoyageContract.source">Source</Translate>
                </th>
                <th>
                  <Translate contentKey="admpocApp.vesselVoyageContract.destination">Destination</Translate>
                </th>
                <th>
                  <Translate contentKey="admpocApp.vesselVoyageContract.period">Period</Translate>
                </th>
                <th>
                  <Translate contentKey="admpocApp.vesselVoyageContract.cost">Cost</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="admpocApp.vesselVoyageContract.home.notFound">No Vessel Voyage Contracts found</Translate>
            </div>
          )
        )}
      </div>

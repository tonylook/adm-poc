...
export const VesselVoyageContractDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="admpocApp.vesselVoyageContract.delete.question">
        <Translate contentKey="admpocApp.vesselVoyageContract.delete.question" interpolate={{ id: vesselVoyageContractEntity.id }}>

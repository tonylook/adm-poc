  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="admpocApp.vesselVoyageContract.home.createOrEditLabel" data-cy="VesselVoyageContractCreateUpdateHeading">
            <Translate contentKey="admpocApp.vesselVoyageContract.home.createOrEditLabel">Create or edit a VesselVoyageContract</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('admpocApp.vesselVoyageContract.holds')}
              ...
              />
              <ValidatedField
                label={translate('admpocApp.vesselVoyageContract.holdCapacity')}
              ...
              />
              <ValidatedField
                label={translate('admpocApp.vesselVoyageContract.source')}
              ...
              />
              <ValidatedField
                label={translate('admpocApp.vesselVoyageContract.destination')}
              ...
              />
              <ValidatedField
                label={translate('admpocApp.vesselVoyageContract.period')}
              ...
              />
              <ValidatedField
                label={translate('admpocApp.vesselVoyageContract.cost')}
